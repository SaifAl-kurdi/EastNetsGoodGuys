...
public class ServiceRegistrar {
    ...
    private void registerService() {
        try {
            CuratorFramework client = zkClientService.getCuratorFramework();
            String servicePath = "/services/notification-service";
            ...
            System.out.println("Notification Service Registered at " + servicePath + " with URL " + serviceUrl);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

...
public class ServiceRegistrar {
    ...
    private void registerService() {
        try {
            ...
            String servicePath = "/services/auth-service";
            ...
            System.out.println("Authentication Service Registered in ZooKeeper at: " + servicePath + " with URL: " + serviceUrl);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
